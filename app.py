...
# -------------------------------------------------------------
# STATIC FRONTEND MOUNTING USING ABSOLUTE PATH
# -------------------------------------------------------------

# Use path resolution relative to the directory of this file
...
if __name__ == "__main__":
    import uvicorn
    # Default to 8000 for standard submissions as requested in hackathon criteria
